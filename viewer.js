...
Preferences._writeToStorage = function (prefObj) {
  return new Promise(function (resolve) {
    ...
    var str = JSON.stringify(prefObj);
    chrome.storage.local.set({'pdfjs.preferences':str},function(){
...
Preferences._readFromStorage = function (prefObj) {
  return new Promise(function (resolve) {
    ...
    chrome.storage.local.get('pdfjs.preferences',function(result){
       if(result){
        var str = JSON.stringify(result);
        var readPrefs = JSON.parse(str);
        resolve(readPrefs);
       }else{
